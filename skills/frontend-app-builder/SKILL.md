...
description: Use for new frontend applications, dashboards, games, creative websites, hero sections, and visually driven UI from scratch, or when the user explicitly asks for a redesign/restyle/modernization. Builds from a clean, airy, high-taste, readable visual concept (reference images or an optional image-gen step), with section-specific references, faithful implementation, and in-browser verification.
---
